...
class NonequilibriumShadowExperimentSetup(object):
    ...
    def _build_lsf_script(self, directory_name: str) -> str:
        ...
        template_script.format(calculation_name=directory_name, memory=8, wallclock_time=self._time_on_cluster, yaml_filename=yaml_filename, estimated_time=self._time_on_cluster)
